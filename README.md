...
**Test totals:** 456 `#[test]` functions across `tests/`. 14 of them call real
Groq (require `GROQ_API_KEY`); 5 run real toolchains (`terraform`, `cargo`,
`erlc`, AtomVM); the rest run hermetically.
